...
bus_dat = [1 103 1.02 0 0 0 0 0; 2 102 1.03 0 0.75 0 0.3 0.1; 3 101 1 0 0 0 0.55 0.13; 4 101 1 0 0 0 0 0; 5 101 1 0 0 0 0.3 0.18; 6 101 1 0 0 0 0.5 0.05]
...
for i = 1:size(line_dat)(1)
	...
	line_power(i, 3) = ((v1)*conj(current));
	line_power(i, 4) = ((v2)*conj(current));
end
disp(line_power)
% disp(Y_bus)
